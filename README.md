...
In the section "output" the following graphics can be found for combinations BoW+LDA and TF-IDF+NMF:
...
- The most frequently occurring words in documents assigned to the most dominant topic,
